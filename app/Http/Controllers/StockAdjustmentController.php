...
class StockAdjustmentController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $stock_adjustments = Transaction::join('business_locations AS BL', 
            ...
            return Datatables::of($stock_adjustments)
                ...
                ->editColumn('total_amount_recovered',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input_data = $request->only([ 'location_id', 'transaction_date', 'adjustment_type', 'additional_notes', 'total_amount_recovered', 'final_total']);
            $business_id = $request->session()->get('user.business_id');
    ...
    public function show($id)
    {
        ...
        $stock_adjustment_details = Transaction::
                    join('stock_adjustment_lines as sl', 
