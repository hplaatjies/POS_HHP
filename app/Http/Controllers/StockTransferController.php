...
use App\BusinessLocation, App\Transaction,
...
class StockTransferController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $stock_transfers = Transaction::join('business_locations AS l1', 
    ...
    public function show($id)
    {
        ...
        $stock_adjustment_details = Transaction::
                    join('transaction_sell_lines as sl', 
    ...
    public function destroy($id)
    {
        ...
        try { 
            if (request()->ajax()) {
                ...
                $deleted_sell_purchase_ids = array();
                $products = array(); //variation_id as array
    ...
    public function printInvoice($id){
        try {
            ...
            $sell_transfer = Transaction::where('business_id', $business_id)
                                ->where('id', $id)
                                ->where('type', 'sell_transfer')
                                ->with('contact', 'sell_lines', 
                                    'sell_lines.product', 
                                    'sell_lines.variations', 
                                    'sell_lines.variations.product_variation', 'location')
                                ->first();
