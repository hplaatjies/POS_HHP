...
return [
    ...
    */
    ...
    'sku' => "Unique product id or Stock Keeping Unit <br><br>Select <b>Auto generate</b> to automatically generate sku.<br><small class='text-muted'>You can modify sku prefix in Business settings.</small>",
