...
<section class="content-header">
    <h1>@lang('purchase.edit_purchase')</h1>
    <!-- <ol class="breadcrumb">
        ...
        <div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::select('contact_id', [ $purchase->contact_id => $purchase->contact->name], $purchase->contact_id, ['class' => 'form-control', 'placeholder' => __('messages.please_select') , 'required']); !!}
            </div>
          </div>
        </div>
