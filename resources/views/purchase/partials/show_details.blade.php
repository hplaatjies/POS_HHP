<div class="row">
  <div class="col-xs-12">
    <h2 class="page-header">
      @lang('purchase.purchase_details') (<b>@lang('purchase.ref_no'):</b> #{{ $purchase->ref_no }})
      <small class="pull-right"><b>@lang('messages.date'):</b> {{ @format_date($purchase->transaction_date) }}</small>
    </h2>
  </div>
</div>
