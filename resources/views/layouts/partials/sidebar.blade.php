  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @if(!auth()->user()->hasRole('Cashier#' . auth()->user()->business_id ))
        ...
        @if(auth()->user()->can('sell.view') || auth()->user()->can('sell.create') || auth()->user()->can('direct_sell.access') )
          <li class="treeview {{  in_array( $request->segment(1), ['sells', 'pos']) ? 'active active-sub' : '' }}" id="tour_step7">
            ...
            <ul class="treeview-menu">
              ...
              @endcan
              @can('sell.create')
                <li class="{{ $request->segment(1) == 'pos' ? 'active' : '' }}"><a href="{{action('SellPosController@create')}}"><i class="fa fa-plus-circle"></i>@lang('sale.pos_sale')</a></li>
        ...
        'units', 'categories', 'barcodes', 'invoice-schemes', 'business-location', 'invoice-layouts', 'printers', 'system-settings']) ) {{'active active-sub'}} @endif">
